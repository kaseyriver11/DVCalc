...
const RESORTS = [
  ...
  // Views: V=Value, R=Resort, SV=Savanna, C=Kilimanjaro Club Concierge
  {
    ...
    travelPeriods: wdwPeriods([
      ...
      { sunThu: { dsV:8, dsR:12, dsSV:15, dsC:20, oneV:19, oneR:24, oneSV:31, oneC:41, twoV:25, twoR:31, twoSV:39, twoC:55, threeR:73, threeSV:79 },
        friSat: { dsV:11, dsR:14, dsSV:17, dsC:23, oneV:21, oneR:28, oneSV:34, oneC:46, twoV:31, twoR:39, twoSV:48, twoC:63, threeR:82, threeSV:89 } },
  ...
  // --- Disney's Animal Kingdom Villas (2027) ---
  {
    id: "animalKingdomVillas",
    name: "Disney's Animal Kingdom Villas",
    year: 2027,
